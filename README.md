A simple Todo application built with React, TypeScript, and Vite, using JSON for data storage. This app allows users to create, edit, and delete tasks with a clean and responsive interface.
